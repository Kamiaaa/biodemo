...
export default function WhatsAppWidget() {
  ...
  useEffect(() => {
    const checkOnlineStatus = () => {
      setIsOnline(Math.random() > 0.5); // 50% chance of being "online"
    };
  ...
  return (
    <div className="fixed bottom-6 right-6 flex flex-col items-end gap-2">
      ...
      <button
        onClick={openChat}
        className="bg-green-500 hover:bg-green-600 text-white p-3 rounded-full shadow-lg transition-colors duration-300 hover:scale-110"
